...
class ProductDetailController extends Controller
{
    public function product_detail($id){
        ...
        $feed_back_products = DB::table('products')
            ...
            ->get();
        $similar_products = products::where('manufacturer_id', $product->manufacturer_id)
            ->where('id', '!=', $id) // Loại bỏ sản phẩm hiện tại
            ->limit(5) // Giới hạn số lượng sản phẩm tương tự
            ->get();
        ...
        return view('user.page.product.product_detail.product_detail',[
            'category' => $category,
            ...
            'similar_products' => $similar_products, // Thêm danh sách sản phẩm tương tự vào view
        ]);
    }

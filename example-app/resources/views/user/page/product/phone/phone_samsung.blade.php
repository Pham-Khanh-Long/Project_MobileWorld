...
@section('breadcrumb')
        <ul class="items-breadcrumb" itemtype="http://schema.org/BreadcrumbList" itemscope>
            ...
            <li class="breadrumb-item" itemscope itemprop="itemListElement" itemtype="http://schema.org/ListItem">
                <span itemprop="name">Điện thoại samssung</span>
...
<ul id="filters" class="filters">
    ...
    <li class="nav-item dropdown-phone">
        <div id="box-filter-brands" class=" filter-brands filter-radio">
            <div class="dropdown-toggle-phone">
                <div class="active">Thương hiệu:</div> <i>Samsung</i>
            </div>
            <div class="box-dropdown-menu-phone">
                <ul class="dropdown-menu-phone">
...
<ul id="series" class="series">
    <li><a href="{{ route('phone_samsung',['title'=>'Galaxy S23'])}}" class="{{ request('title') == 'Galaxy S23'  ? 'active' : '' }}">Galaxy S23 Series</a></li>
    <li><a href="{{ route('phone_samsung',['title'=>'Galaxy Z Fold4'])}}"class="{{ request('title') == 'Galaxy Z Fold4'  ? 'active' : '' }}">Galaxy Z Fold4</a></li>
    <li><a href="{{ route('phone_samsung',['title'=>'Galaxy S22'])}}"class="{{ request('title') == 'Galaxy S22'  ? 'active' : '' }}">Galaxy S22 Series</a></li>
    <li><a href="{{ route('phone_samsung',['title'=>'Galaxy S21'])}}"class="{{ request('title') == 'Galaxy S21'  ? 'active' : '' }}">Galaxy S21 Series</a></li>
    <li><a href="{{ route('phone_samsung',['title'=>'Galaxy Note 20'])}}"class="{{ request('title') == 'Galaxy Note 20'  ? 'active' : '' }}">Galaxy Note 20 Series</a></li>
    <li><a href="{{ route('phone_samsung',['title'=>'Galaxy S20'])}}"class="{{ request('title') == 'Galaxy S20'  ? 'active' : '' }}">Galaxy S20 Series</a></li>
    <li><a href="{{ route('phone_samsung',['title'=>'Galaxy Note 10'])}}"class="{{ request('title') == 'Galaxy Note 10'  ? 'active' : '' }}">Galaxy Note 10 Series</a></li>
    <li><a href="{{ route('phone_samsung',['title'=>'Galaxy S10'])}}"class="{{ request('title') == 'Galaxy S10'  ? 'active' : '' }}">Galaxy S10 Plus | S10 5G</a></li>
    <li><a href="{{ route('phone_samsung',['title'=>'Galaxy Z Fold3'])}}"class="{{ request('title') == 'Galaxy Z Folde3'  ? 'active' : '' }}">Galaxy Z Fold3</a></li>
</ul>
